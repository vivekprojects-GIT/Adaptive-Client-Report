...
def cleanup_strategy_format_metadata(store: MongoStore) -> int:
    """Remove non-MVP1 strategy alias fields from existing config rows."""
    result = store.config.update_many(
        {"entity_type": "strategy"},
        {"$unset": {
